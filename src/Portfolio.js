...
class Portfolio extends Component {
    ...
    render(){
        ...
        <Fragment>
            <div class="row">
            <div class="project-intro">Here are some things I've built. Check my <a id="build" target="_blank" href="https://github.com/thomgardiner">github</a> for more! Heroku links may take a moment to load.</div>
            </div>
            <div class="row">
                <div class="port-container">
                    <div class="port-item" id="1">
                        ...
                        <p class="project-github"><a target="_blank" href="https://github.com/thomgardiner/DAW">Github Repo</a></p>
                    </div>
            ...
            <div class="row">
                <div class="port-container-2">
                    <div class="port-item" id="4">
                        ...
                        <p class="project-github"><a target="_blank" href="https://github.com/thomgardiner/gif-app">Github Repo</a></p>
                    </div>
                    <div class="port-item" id="5">
                        ...
                        <p class="project-github"><a target="_blank" href="https://github.com/thomgardiner/quiz-app">Github Repo</a></p>
                    </div>
                </div>
            </div>
        </Fragment>
